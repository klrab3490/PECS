...
const ToCompleteCard = ({ toComplete }) => {
  ...
  const { user , completeCollection,incompleteCollection,toDoComplete  } = useGlobalContext();
  ...
  const markAsComplete = (e) => {
    ...
    axios.put(`/api/admin/${toComplete._id}/complete`).then((res) => {
    ...
    <div className="todo--complete">
      ...
      <div className="todo__controls">
          <>
            ...
            <button onClick={markAsComplete} >{user.role === 'Collector' ? "Complete" : ""}</button>
